...
<head>
    ...
    <link rel="stylesheet" href="css/questions-archive.css">
    <script src="javascript/student-appearance.js" defer></script>
    <script src="javascript/questions-archive.js" defer></script>
</head>
<body>
    ...
    <header>
        <nav class="navbar">
            <div class="logo-page-name-container">
                ...
                <div class="page-name">
                    <img src="<?php echo htmlspecialchars($_SESSION['theme'] === 'dark' ? 'assets/darkquestionsarchive.png' : 'assets/questionsarchive.png'); ?>" alt="page title">
                </div>
            </div>
        </nav>
    </header>
